...
export default function About() {
  return (
    <div className="min-h-screen bg-zinc-50 font-sans dark:bg-black">
      ...
      {/* Hero 섹션 */}
      <div className="h-[810px] w-full flex items-center justify-center relative overflow-hidden">
        {/* 배경 이미지 */}
        <Image
      ...
      <div className="w-full bg-white py-16">
        <div className="max-w-full mx-auto px-3 md:px-8">
          ...
          <div className="space-y-0">
            <div className="flex justify-between items-center h-[39px] border-b border-black">
              <span className="text-gray-900">ISO 17024 ESG Auditor(ESG 국제심사원) IQCS</span>
              <span className="text-gray-600">2023.09</span>
            </div>
            
            <div className="flex justify-between items-center h-[39px] border-b border-black">
              <span className="text-gray-900">Green Coffee Professional. SCA</span>
              <span className="text-gray-600">2017.09</span>
            </div>
            
            <div className="flex justify-between items-center h-[39px] border-b border-black">
              <span className="text-gray-900">Roasting Professional. SCA</span>
              <span className="text-gray-600">2017.08</span>
            </div>
            
            <div className="flex justify-between items-center h-[39px] border-b border-black">
              <span className="text-gray-900">Sensory Skills Professional. SCA</span>
              <span className="text-gray-600">2017.08</span>
            </div>
            
            <div className="flex justify-between items-center h-[39px] border-b border-black">
              <span className="text-gray-900">티소믈리에. (사)한국티협회</span>
              <span className="text-gray-600">2017.06</span>
            </div>
            
            <div className="flex justify-between items-center h-[39px] border-b border-black">
              <span className="text-gray-900">Brewing Professional. SCA</span>
              <span className="text-gray-600">2017.05</span>
            </div>
            
            <div className="flex justify-between items-center h-[39px] border-b border-black">
              <span className="text-gray-900">Barista Skills Professional. SCA</span>
              <span className="text-gray-600">2017.04</span>
            </div>
            
            <div className="flex justify-between items-center h-[39px] border-b border-black">
              <span className="text-gray-900">조주기능사. 한국산업인력공단</span>
              <span className="text-gray-600">2015.12</span>
            </div>
            
            <div className="flex justify-between items-center h-[39px]">
              <span className="text-gray-900">커피마스터. 한국커피연합회</span>
              <span className="text-gray-600">2015.12</span>
            </div>
          </div>
        </div>
      ...
      <div className="w-full bg-white py-16">
        <div className="max-w-full mx-auto px-3 md:px-8">
          ...
          {/* CI 설명 텍스트 */}
          <div className="max-w-full">
            <p className="text-gray-900 text-[1rem] leading-[1.2em] mt-[70px]">
