...
export default function AnimatedPartners() {
  ...
  return (
    <div id="partners" className="w-full h-[554px] md:h-auto md:py-20" style={{ backgroundColor: '#A2AD71' }}>
      <div className="w-full px-3 md:px-[30px] h-full md:h-auto flex flex-col">
        <div className="pt-[30px] md:pt-0 md:mb-0">
          <h2 className="text-[1.2rem] md:text-[1.9rem] leading-[0.9] font-bold text-white mb-[30px]">Partners</h2>
          <div className="text-white text-[0.8rem] md:text-[1rem] leading-[1.2]">
      ...
      {/* 데스크톱: 파트너 그리드 */}
      <div className="hidden md:grid grid-cols-2 gap-24 px-3 md:px-[30px] mt-[20px] mb-[60px]">
        {/* Favrichon */}
